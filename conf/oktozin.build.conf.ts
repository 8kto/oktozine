...
const mainModuleConf: Partial<IDocumentConfig> = {
  ...
  include: [],
  skipped: [
    "0405-appendix-q1--micomant--osr.md",
    "0405-appendix-q1--micomant--osr-1.md",
  ],
  tocConfig: {
    headersSelector:
      "h1:not([data-skip-toc]), h2:not([data-skip-toc]), h3, h4, h5",
...
const mainBestiaryConf: Partial<IDocumentConfig> = {
  ...
  skipped: [],
  includePattern:
    /front-cover-bestiary|title-bestiary|toc|notes-bestiary|bestiary|back-cover/,
...
const config: IModuleBuilderConfig = {
  ...
  referenceFiles: [
    "src/markdown/$refs-stats.md",
    "src/markdown/$refs-items.md",
    "src/markdown/$refs-blocks.md",
  ],
  conditionalsAlias: {
    bestiary: "main",
    "bestiary-osr": "osr",
